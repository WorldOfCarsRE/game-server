...
from game.otp.friends import FriendResponseCodes
...
class PlayerFriendsManager(DistributedObjectGlobal):
    ...
    def __init__(self, cr):
        ...
        self.accept('gotExtraFriendHandles',
                    self._PlayerFriendsManager__handleFriendHandles)
    ...
    def _PlayerFriendsManager__handleFriendHandles(self, handleList):
