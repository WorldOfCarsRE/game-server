...
def getNametagFont(index):
    if index not in NametagFonts or NametagFonts[index] is None:
        if index not in NametagFontPaths or NametagFontPaths[index] is None:
            ...
            NametagFonts[index] = loader.loadFont(NametagFontPaths[index],
                                                  lineHeight=1.0)
...
DefaultBackgroundColor = (0.29999999999999999, 0.29999999999999999,
...
toonBodyScales = {
    ...
    'bear': 0.84999999999999998,
    'pig': 0.77000000000000002
}
toonHeadScales = {
    'mouse': Point3(1.0),
    'cat': Point3(1.0),
