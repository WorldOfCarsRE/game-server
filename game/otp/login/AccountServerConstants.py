...
class AccountServerConstants(RemoteValueSet):
    ...
    def getBool(self, name):
        return self._AccountServerConstants__getConstant(
            name, RemoteValueSet.getBool)

    def getInt(self, name):
        return self._AccountServerConstants__getConstant(
            name, RemoteValueSet.getInt)

    def getFloat(self, name):
        return self._AccountServerConstants__getConstant(
            name, RemoteValueSet.getFloat)

    def getString(self, name):
        return self._AccountServerConstants__getConstant(
            name, RemoteValueSet.getString)
