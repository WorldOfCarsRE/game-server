...
class TTAccount:
    ...
    def createAccount(self, loginName, password, data):
        return self.talk('create',
                         data=self._TTAccount__makeLoginDict(
                             loginName, password, data))

    def authorize(self, loginName, password):
        return self.talk('play',
                         data=self._TTAccount__makeLoginDict(
                             loginName, password))
    ...
    def setParentPassword(self, loginName, password, parentPassword):
        return self.talk('setParentPassword',
                         data=self._TTAccount__makeLoginDict(
                             loginName, password,
    ...
    def authenticateParentPassword(self, loginName, password, parentPassword):
        ...
        try:
            errorMsg = self.talk('authenticateParentPassword',
                                 data=self._TTAccount__makeLoginDict(
    ...
    def enableSecretFriends(self,
        ...
        try:
            errorMsg = self.talk('setSecretChat',
                                 data=self._TTAccount__makeLoginDict(
                                     loginName, parentPassword, {
                                         'chat':
