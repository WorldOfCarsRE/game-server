...
class CreateAccountScreen(StateData.StateData, GuiScreen.GuiScreen):
    ...
    def load(self):
        ...
        self.nameLabel = DirectLabel(
            ...
            text_shadow=(0, 0, 0, 1),
            text_shadowOffset=(0.080000000000000002, 0.080000000000000002))
        ...
        self.submitButton = DirectButton(
            ...
            text_pos=(0, -0.02),
            command=self._CreateAccountScreen__handleSubmit)
        ...
        self.dialog = dialogClass(dialogName='createAccountDialog',
    ...
    def enterCreate(self):
        ...
        self.startFocusMgmt(
            overrides={},
            globalFocusHandler=self._CreateAccountScreen__handleFocusChange)
    ...
    def _CreateAccountScreen__handleSubmit(self):
        ...
        if self.userName == '':
            ...
            self.acceptOnce(self.dialogDoneEvent,
                            self._CreateAccountScreen__handleUsernameAck)
            ...
            self.dialog.show()
            self.acceptOnce(self.dialogDoneEvent,
                            self._CreateAccountScreen__handlePasswordAck)
    ...
    def enterWaitForLoginResponse(self):
        ...
        try:
            ...
            self.acceptOnce(
                ...
                self._CreateAccountScreen__handleConnectionErrorAck)
            return None
        ...
        if error:
            ...
            self.dialog.show()
            self.acceptOnce(self.dialogDoneEvent,
                            self._CreateAccountScreen__handleBadAccountAck)
        else:
    ...
    def handleLoginResponseMsg(self, di):
        ...
        if returnCode == 0:
            ...
            self.dialog.show()
            self.acceptOnce(self.dialogDoneEvent,
                            self._CreateAccountScreen__handleBadPasswordAck)
        elif returnCode == 14:
            ...
            self.dialog.show()
            self.acceptOnce(self.dialogDoneEvent,
                            self._CreateAccountScreen__handleBadWordInUserName)
        elif returnCode == 129:
