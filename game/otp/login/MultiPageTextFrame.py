...
class MultiPageTextFrame(DirectFrame):
    ...
    def __init__(self,
        ...
        optiondefs = (('relief', DGG.SUNKEN, None),
                      ('frameSize', (-hWidth, hWidth, -hHeight, hHeight),
                       None), ('frameColor',
                               (0.84999999999999998, 0.84999999999999998,
                                0.59999999999999998, 1), None),
                      ('borderWidth', (0.01, 0.01), None), ('text', '', None),
                      ('text_pos', (-hWidth * 0.94999999999999996,
                                    hHeight * 0.93000000000000005),
                       None), ('text_scale', 0.050000000000000003, None),
                      ('text_align', TextNode.ALeft, None), ('text_wordwrap',
                                                             wordWrap, None))
        ...
        self.prevButton = DirectButton(
            ...
            command=self.turnPage,
            extraArgs=[-1])
        self.pageNum = DirectLabel(relief=None,
                                   parent=self,
