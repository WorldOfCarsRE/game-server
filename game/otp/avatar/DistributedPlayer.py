...
import time
from game.otp.avatar import Avatar, PlayerBase
from game.otp.chat import TalkAssistant
from game.otp.otpbase import OTPGlobals
from game.otp.avatar.Avatar import teleportNotify
from game.otp.distributed.TelemetryLimited import TelemetryLimited
if base.config.GetBool('want-chatfilter-hacks', 0):
    from game.otp.switchboard import badwordpy
    import os
