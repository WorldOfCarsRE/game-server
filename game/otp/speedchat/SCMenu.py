...
class SCMenu(SCObject, NodePath):
    ...
    def __init__(self, holder=None):
        ...
        (self.bgTop, self.bgBottom, self.bgLeft, self.bgRight, self.bgMiddle,
         ...
         self.bgBottomRight) = findNodes([('top', 'top1'), 'bottom', 'left',
                                          'right', 'middle', 'topLeft',
                                          'bottomLeft', 'topRight',
                                          'bottomRight'])
        ...
        def addChildren(menu, childList):
            for child in childList:
                ...
                if isinstance(child, type([])):
                    ...
                    continue
                if isinstance(child, type('')) and child[:2] == 'gm':
    ...
    def finalize(self):
        ...
        memberWidth = maxWidth
        memberHeight = maxHeight
        self.width = maxWidth
    ...
    def append(self, element):
        if isinstance(self._SCMenu__members, tuple):
