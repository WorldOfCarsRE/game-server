from .messagetypes import CLIENT_GET_AVATAR_DETAILS, CLIENT_GET_PET_DETAILS
...
TUTORIAL_LOBBY_INTEREST_HANDLE = 6
OTP_NET_MESSENGER_CHANNEL = (OTP_DO_ID_UBER_DOG << 32) + OTP_ZONE_ID_MANAGEMENT
OTP_DO_ID_CARS_HOLIDAY_MANAGER = 4756
OTP_DO_ID_CARS_SHARD_MANAGER = 4757

messageToClass = {
    CLIENT_GET_AVATAR_DETAILS: 'DistributedToon',
    CLIENT_GET_PET_DETAILS: 'DistributedPet'
}