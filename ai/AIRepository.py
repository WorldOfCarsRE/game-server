...
class AIRepository:
    ...
    def createObjects(self):
        ...
        from .Objects import DistributedZoneAI, CarPlayerStatusAI
        ...
        self.carPlayerStatus = CarPlayerStatusAI(self)
        self.generateWithRequired(self.carPlayerStatus, OTP_DO_ID_FAIRIES, OTP_ZONE_ID_ELEMENTS)
