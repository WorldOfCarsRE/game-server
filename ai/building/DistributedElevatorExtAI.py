...
from .DistributedElevatorFSMAI import DistributedElevatorFSMAI
from direct.task import Task
from direct.directnotify import DirectNotifyGlobal

class DistributedElevatorExtAI(DistributedElevatorFSMAI):
    ...
    def __init__(self, air, bldg, numSeats = 4, antiShuffle = 0, minLaff = 0):
        DistributedElevatorFSMAI.__init__(
    ...
    def delete(self):
        ...
        DistributedElevatorFSMAI.delete(self)
    ...
    def acceptBoarder(self, avId, seatIndex, wantBoardingShow = 0):
        DistributedElevatorFSMAI.acceptBoarder(self, avId, seatIndex, wantBoardingShow)
        self.acceptOnce(self.air.getDeleteDoIdEvent(avId),
    ...
    def enterOpening(self):
        DistributedElevatorFSMAI.enterOpening(self)
    ...
    def enterWaitEmpty(self):
        DistributedElevatorFSMAI.enterWaitEmpty(self)
        self.anyToonsBailed = 0

    def enterWaitCountdown(self):
        DistributedElevatorFSMAI.enterWaitCountdown(self)
    ...
    def enterAllAboard(self):
        DistributedElevatorFSMAI.enterAllAboard(self)
    ...
    def enterClosing(self):
        DistributedElevatorFSMAI.enterClosing(self)
